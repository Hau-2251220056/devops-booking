...
import { AlertCircle, BadgeCheck, Search, Star, Users } from "lucide-react";
...
function BarbersPage() {
  ...
  const filteredBarbers = barbers.filter((barber) => {
    const fullName =
      `${barber?.user?.firstName || ""} ${barber?.user?.lastName || ""}`.toLowerCase();
          ...
          <div className="container">
            <div className="barbers-hero-grid">
              <div className="barbers-hero-copy">
                ...
                <p className="lead">
                  Xem toàn bộ đội ngũ, lọc theo khả năng phục vụ và đặt lịch
                  trực tiếp với thợ bạn muốn.
                </p>
          ...
          <div className="container">
            ...
            {selectedBarberId ? (
              <div className="selected-note">
                Bạn đã chọn sẵn thợ từ link trước đó.{" "}
                <Link to={`/booking?barberId=${selectedBarberId}`}>
                  Tiếp tục đặt lịch
                </Link>
              </div>
            ) : null}
            ...
            {loading ? (
              <div className="barbers-state">
                Đang tải danh sách thợ cắt tóc...
              </div>
            ) : error ? (
              ...
              <div className="barbers-state empty">
